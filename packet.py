...
class Packet:
    ...
    END_BYTE = 0x03
    LENGTH = 7  # bytes
    PAYLOAD_STRUCTURE = ">hh"
    PACKET_STRUCTURE = ">B4sBB"

    def __init__(self, serial_connection):
        self.serial_connection = serial_connection
    
    def create(self, speed_L, speed_R):
        self.speed_L = speed_L
        self.speed_R = speed_R

    def send(self):
        # Convert speeds to 2-byte signed integers
        self.payload = struct.pack(self.PAYLOAD_STRUCTURE, self.speed_L, self.speed_R)
    ...
    def print(self):
        print(f"Sended: {self.speed_L}\t{self.speed_R}")
